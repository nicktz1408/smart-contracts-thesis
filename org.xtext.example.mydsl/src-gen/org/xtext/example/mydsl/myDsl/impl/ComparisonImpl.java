 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ComparisonImpl#getOp <em>Op</em>}</li>
...
public class ComparisonImpl extends ExpressionImpl implements Comparison
{
  ...
  public void setOp(String newOp)
  {
    ...
    op = newOp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.COMPARISON__OP, oldOp, op));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.COMPARISON__LEFT:
        return getLeft();
      case MyDslPackage.COMPARISON__OP:
        return getOp();
      case MyDslPackage.COMPARISON__RIGHT:
        return getRight();
    }
