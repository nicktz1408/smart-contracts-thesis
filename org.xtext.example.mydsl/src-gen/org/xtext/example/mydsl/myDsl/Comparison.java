 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.Comparison#getOp <em>Op</em>}</li>
...
public interface Comparison extends Expression
{
   ...
   * @see #setOp(String)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getComparison_Op()
   * @model
   * @generated
   */
  String getOp();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.Comparison#getOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
